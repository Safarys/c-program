...
?>
    ...
    <tr>
        ...
        <th>
            <input type="text" name="id" value="<?php echo $count+=1;  ?>" id="" required="on" readonly>
        </th>
    ...
    <tr>
        ...
        <th>
        <a href="display.php" style="background-color:;color:black;border: radius 25px;">DISPLAY THE TABLE</a>
        </th>
    </tr>
</table>
</form>
